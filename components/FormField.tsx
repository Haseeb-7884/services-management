    ...
    return (
      <div>
        ...
        <div className="relative">
          {Icon && <Icon size={16} className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--brand-text-muted)]" />}
          <input
            ref={ref}
            id={fieldId}
            ...
            style={{ borderColor: error ? "#dc2626" : "var(--border-subtle)", backgroundColor: "var(--surface-card)" }}
            onFocus={(e) => {
