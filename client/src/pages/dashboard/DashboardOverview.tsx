  ...
  return (
    <div>
      <div className="mb-8 flex flex-wrap items-center justify-between gap-3">
        ...
        <Link
          to="/upload"
          className="btn-glow flex items-center gap-2 rounded-lg px-5 py-2.5 text-sm font-bold"
      ...
      {/* Content mix - real breakdown by type, since per-day view history isn't tracked yet */}
              ...
              return (
                <div key={type}>
                  <div className="mb-1.5 flex items-center justify-between text-sm">
                    ...
                    <span className="text-[var(--brand-text-muted)]">{count} · {percent}%</span>
                  </div>
      ...
      <div className="overflow-hidden rounded-2xl border" style={{ borderColor: "var(--border-subtle)", backgroundColor: "var(--surface-card)", boxShadow: "var(--shadow-sm)" }}>
        <div className="flex items-center justify-between border-b px-6 py-4" style={{ borderColor: "var(--border-subtle)" }}>
          ...
          <Link to="/dashboard/content" className="text-sm font-semibold text-[var(--brand-primary)]">
            View all →
          </Link>
        </div>
