    ...
    <div className="mx-auto max-w-7xl px-4 py-8">
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1fr_320px]">
        ...
        <div className="mx-auto w-full max-w-2xl lg:mx-0">
          ...
          <span
            className="mb-3 inline-block rounded-full border px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-wide"
          ...
          <div className="mb-6 flex flex-wrap items-center gap-3.5">
            <Link to={`/u/${article.owner.username}`} className="h-11 w-11 shrink-0 overflow-hidden rounded-full border-2" style={{ borderColor: "var(--border-medium)" }}>
            ...
            <div>
              <Link to={`/u/${article.owner.username}`} className="flex items-center gap-1.5">
          ...
          {/* Body */}
          <div className="mb-8 whitespace-pre-wrap text-[15px] leading-relaxed text-[var(--brand-text)]">
            {article.body}
          </div>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-[var(--brand-text-muted)]">
                      {item.owner.profile?.displayName || item.owner.username}
                    </p>
                  </div>
                </Link>
              ))}
