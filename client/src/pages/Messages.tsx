    ...
    <div className="mx-auto flex h-[calc(100vh-4rem)] max-w-6xl">
      ...
      <aside className="w-full max-w-xs shrink-0 overflow-y-auto border-r px-3 py-5" style={{ borderColor: "var(--border-subtle)" }}>
        ...
        {!loading && conversations.length === 0 && (
          <p className="px-2 text-sm text-[var(--brand-text-muted)]">
            No conversations yet. Visit a creator's channel to start one.
          </p>
        )}
              ...
              >
                ...
                >
                  {other.profile?.avatarUrl ? (
                    <img src={other.profile.avatarUrl} alt={other.username} className="h-full w-full object-cover" />
                  ) : (
                    (other.profile?.displayName || other.username).charAt(0).toUpperCase()
                  )}
                </span>
                    ...
                    <div
                      ...
                      style={
                        mine
                          ...
                          : { backgroundColor: "var(--surface-card)", color: "var(--brand-text)", border: "1px solid var(--border-subtle)" }
                      }
                    >
                      {m.body}
                    </div>
