      ...
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1fr_360px]">
        ...
        <div>
          ...
          <div className="mb-5 flex flex-wrap items-center gap-3.5">
            <Link to={`/u/${video.owner.username}`} className="h-11 w-11 shrink-0 overflow-hidden rounded-full border-2" style={{ borderColor: "var(--border-medium)" }}>
            ...
            <div>
              <Link to={`/u/${video.owner.username}`} className="flex items-center gap-1.5">
              ...
              {upNext.map((item) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mb-0.5 text-[11px] text-[var(--brand-text-muted)]">
