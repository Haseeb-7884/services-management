...
export function ArticleFeed() {
  ...
  useSeo({ title: "Articles", description: "Written posts and stories from every channel." });
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <div className="mb-6">
        <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-[var(--brand-text)]">Articles</h1>
        <p className="text-sm text-[var(--brand-text-muted)]">Written posts and stories from every channel.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border py-16 text-center" style={{ borderColor: "var(--border-subtle)", backgroundColor: "var(--surface-card)" }}>
          ...
          <p className="text-sm font-medium text-[var(--brand-text)]">No articles found</p>
