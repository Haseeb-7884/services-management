...
const siteConfigSchema = new Schema(
  {
    ...
    // Seed values below match the client's current light theme 1:1 (see
    // client/src/index.css :root block and docs/AI-UI-Generation-Prompt.md).
...
export const SiteConfig: Model<SiteConfigDocument> = model<SiteConfigDocument>(
  "SiteConfig",
  siteConfigSchema
);
